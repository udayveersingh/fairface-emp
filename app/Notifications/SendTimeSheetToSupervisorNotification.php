...
class SendTimeSheetToSupervisorNotification extends Notification
{
    use Queueable;
    ...
    {
        return [
            'employee_id' => $this->emp_timesheet['employee_id'],
            'supervisor_id' => $this->emp_timesheet['supervisor_id'],
