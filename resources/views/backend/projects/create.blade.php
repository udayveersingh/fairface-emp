    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="project_name"
                    value="{{ !empty($project->name) ? $project->name : '' }}">
        ...
        <div class="col-sm-6">
            ...
            <select name="project_type" class="form-control">
                ...
                <option
                    value="internal"{{ !empty($project->project_type) && $project->project_type == 'internal' ? 'selected' : '' }}>
                    Internal</option>
                <option
                    value="external"{{ !empty($project->project_type) && $project->project_type == 'external' ? 'selected' : '' }}>
                    External</option>
            </select>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="contract_id"
                    value="{{ !empty($project->contract_id) ? $project->contract_id : '' }}">
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="client_name"
                    value="{{ !empty($project->client_name) ? $project->client_name : '' }}">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <textarea name="client_address" id="edit_client_address" rows="4" class="form-control"> {{ !empty($project->client_address) ? $project->client_address : '' }}</textarea>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="work_location"
                    value="{{ !empty($project->work_location) ? $project->work_location : '' }}">
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="cal-icon">
                    <input class="form-control datetimepicker" type="text" name="start_date"
                        value="{{ !empty($project->client_cont_start_date) ? $project->client_cont_start_date : '' }}">
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="cal-icon">
                    <input class="form-control datetimepicker" name="end_date" type="text"
                        value="{{ !empty($project->client_cont_end_date) ? $project->client_cont_end_date : '' }}">
                </div>
            </div>
        </div>
    </div>
