        ...
        <div class="card card-block shadow shadow-sm p-3 h-100">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>{{ !empty($employee_bank->bank_account_number) ? $employee_bank->bank_account_number : '' }}</td>
                </tr>
                <tr>
            ...
            <div class="btn-group text-center mx-auto mt-auto" style="max-width: 200px;">
                <a class="btn btn-primary w-100 " id="employee_bank_btn" href="javascript:void(0)" data-toggle="modal"><i
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" action="{{ route('employee-bank.update') }}">
                            ...
                            <input type="hidden" value="{{ !empty($employee->id) ? $employee->id : '' }}" id="emp_id"
                                name="emp_id">
                            <div class="row">
                                <div class="col-sm-6">
