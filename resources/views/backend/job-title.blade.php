...
<div class="row align-items-center">
    ...
    <div class="col-auto float-right ml-auto">
        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_job_Title"><i class="fa fa-plus"></i> Add Job Title</a>
    </div>
</div>
@endsection
                        ...
                        <td class="text-right">
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a data-id="{{$job_title->id}}" data-title="{{$job_title->title}}" data-description="{{$job_title->description}}" class="dropdown-item editbtn" href="javascript:void(0);" data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a data-id="{{$job_title->id}}" class="dropdown-item deletebtn" href="javascript:void(0);" data-target="#deletebtn" data-toggle="modal"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{route('job-title')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="title" id="job_title" type="text">
                                        </div>
                                        <div class="form-group">
