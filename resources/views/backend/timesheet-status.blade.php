...
@section('page-header')
    <div class="row align-items-center">
        ...
        <div class="col-auto float-right ml-auto">
            <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_timeSheet_status"><i
                    class="fa fa-plus"></i> Add TimeSheet Status</a>
        </div>
    </div>
@endsection
                ...
                <table class="table table-striped custom-table mb-0 datatable">
                    ...
                    <tbody>
                        @if (!empty($timesheet_statuses->count()))
                            @foreach ($timesheet_statuses as $index => $timesheet_status)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a data-id="{{ $timesheet_status->id }}"
                                                    data-status="{{ $timesheet_status->status }}"
                                                    class="dropdown-item editbtn" href="javascript:void(0);"
                                                    data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                <a data-id="{{ $timesheet_status->id }}" class="dropdown-item deletebtn"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('timesheet-status') }}">
                                                ...
                                                <input class="form-control" name="timesheet_status" id="edit_status"
                                                    type="text">
