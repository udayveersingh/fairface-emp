                        ...
                        <div class="form-group">
                            ...
                            <select name="" id="month" class="select month">
                                ...
                                @foreach (getMonth() as $index => $month)
                                    <option
                                        value="{{ $index + 1 }}"{{ !empty($month_value) && $month_value == $index + 1 ? 'selected' : '' }}>
                                        {{ $month }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <table class="table">
                            ...
                            <tbody id="bodyData">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" style="width:80%" class="form-control" name="calender_date[]"
                                            value="{{ $timesheet->calender_date }}"></td>
                                    <td><input type="text" style="" class="form-control" name="calender_day[]"
                                            value="{{ $timesheet->calender_day }}"></td>
                                    <td><input name="start_time[]" value="" class="form-control start_time"
                                            type="time" value="{{ $timesheet->start_time }}"></td>
                                    <td><input name="end_time[]" value="{{ $timesheet->end_time }}" type="time"
                                            class="form-control end_time"></td>
                                    <td><select name="hours[]" id="hours" class="form-control hours">
                                    ...
                                    <td><select name="project_phase_id[]" id="project_phase_id" class="select form-control">
                                    ...
                                    <td>
                                        <textarea class="form-control" id="notes" name="notes[]" rows="3" cols="10"></textarea>
                                    </td>
                                </tr>
            @endforeach
            </tbody>
