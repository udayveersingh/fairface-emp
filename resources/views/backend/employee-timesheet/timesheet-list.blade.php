                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex" style="align-items: center;">
                                <p style="white-space:nowrap;" class="m-0" data-toggle="tooltip" data-html="true" title="{{$timesheet->status_reason}}">
                                    {{ substr($timesheet->status_reason, 0, 10) . ' ...' }}
                                </p>
                            </td>
                            ...
                            <td class="text-right">
                                ...
                                <!-- <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{route('employee-timesheet-detail',['id' => $timesheet->employee_id,'start_date'=> $start_date[0],'end_date' => $end_date[0]])}}"><i class="fa fa-eye m-r-5"></i>View</a>
