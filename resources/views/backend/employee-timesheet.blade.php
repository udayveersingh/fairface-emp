...
<div class="row align-items-center">
    ...
    <div class="col-auto float-right ml-auto">
        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_employee_timesheet"><i class="fa fa-plus"></i>Add Employee TimeSheet</a>
    </div>
</div>
@endsection
                        ...
                        <td class="text-right">
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a data-id="{{$timesheet->id}}" data-timesheet_id="{{$timesheet->timesheet_id}}" data-employee_id="{{$timesheet->employee_id}}" data-supervisor_id="{{$timesheet->supervisor_id}}" data-project_id="{{$timesheet->project_id}}" data-project_phase_id="{{$timesheet->project_phase_id}}" data-calendar_day="{{$timesheet->calender_day}}" data-calendar_date="{{$timesheet->calender_date}}" data-from_time="{{$timesheet->from_time}}" data-to_time="{{$timesheet->to_time}}" data-total_hours_worked="{{$timesheet->total_hours_worked}}" data-notes="{{$timesheet->notes}}" data-timesheet_status_id="{{$timesheet->timesheet_status_id}}" data-status_reason="{{$timesheet->status_reason}}" data-edit_approved_date_time="{{$timesheet->approved_date_time}}" class="dropdown-item editbtn" href="javascript:void(0);" data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a data-id="{{$timesheet->id}}" class="dropdown-item deletebtn" href="javascript:void(0);" data-target="#deletebtn" data-toggle="modal"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="timesheet_id" id="edit_timesheet_id" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="employee_id" id="edit_employee_id" class="select form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="project_id" id="edit_project_id" class="select form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="calendar_day" id="edit_calendar_day" class="select form-control">
                                                        @php
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="calender_date" id="edit_calendar_date" type="date">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="from_time" id="edit_from_time" type="time">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="to_time" id="edit_to_time" type="time">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label">Total Hours Worked<span class="text-danger">*</span></label>
                                                    <input class="form-control" id="edit_total_hours_works" name="total_hours_works" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="approved_date_time" id="edit_approved_datetime" type="date">
                                                </div>
                                            </div>
                                        </div>
