                ...
                <div class="col-md-8">
                    <div class="card card-block shadow shadow-sm p-3 h-100">
                        ...
                        <div class="btn-group text-center mx-auto mt-auto" style="max-width: 200px;">
                            <a class="btn btn-primary w-100 " id="employee_edit_btn"
                                href="javascript:void(0)" data-id="{{ !empty($employee->id) ? $employee->id : '' }}"
                                ...
                                data-passport_expiry_date="{{ $employee->passport_expiry_date }}" data-toggle="modal"><i
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" value="{{ $employee->employee_id }}"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control edit_phone mask_phone_number"
                                                        name="phone" value="{{ $employee->phone }}" type="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control edit_al_phone_number mask_phone_number"
                                                        ...
                                                        value="{{ $employee->alternate_phone_number }}" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="col-form-label">Email <span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control edit_email" value="{{ $employee->email }}"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control edit_date_of_birth" name="date_of_birth"
                                                        value="{{ $employee->date_of_birth }}" type="date">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
