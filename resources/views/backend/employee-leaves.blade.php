						...
						<td class="text-right">
							<div class="dropdown dropdown-action">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a data-id="{{$leave->id}}" data-leave_type="{{$leave->leave_type_id}}" data-employee="{{$leave->employee_id}}" data-supervisor="{{$leave->supervisor_id }}" data-project="{{$leave->project_id}}" data-project_phase="{{$leave->project_phase_id}}" data-from="{{$leave->from}}" data-to="{{$leave->to}}"  data-leave_reason="{{$leave->reason}}" data-status_reason="{{$leave->status_reason}}" data-approved_date_time="{{$leave->approved_date_time}}"  data-timesheet_status_id ="{{$leave->timesheet_status_id}}"  class="dropdown-item editbtn" href="javascript:void(0)" data-toggle="modal" data-target="#edit_leave"><i class="fa fa-pencil m-r-5"></i> Edit</a>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{route('employee-leave')}}" method="post">
					...
					<div class="form-group">
						<label class="col-form-label">Approved Date/Time<span class="text-danger">*</span></label>
						<input class="form-control datetimepicker" name="approved_date_time" id="edit_approved_date_time" type="text">
					</div>
