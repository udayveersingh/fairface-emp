...
<div class="row align-items-center">
    ...
    <div class="col-auto float-right ml-auto">
        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_project_phase"><i class="fa fa-plus"></i> Add Project Phase</a>
    </div>
</div>
@endsection
                        ...
                        <td class="text-right">
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a data-id="{{$project_phase->id}}" data-project_phase="{{$project_phase->name}}" class="dropdown-item editbtn" href="javascript:void(0);" data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a data-id="{{$project_phase->id}}" class="dropdown-item deletebtn" href="javascript:void(0);" data-target="#deletebtn" data-toggle="modal"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{route('project-phase')}}">
                                        ...
                                        <select name="project_phase" id="project_phase" class="select form-control">
                                            <option value="">Select Project Phase</option>
                                            <option value="Project_planning">Project Planning</option>
                                            <option value="requirements_gathering">Requirements Gathering</option>
